...
let config = {
  ...
  DENSITY_DISSIPATION: 1 /* How long each movement persists, lower is longer default: 5 */,
  VELOCITY_DISSIPATION: 5,
  PRESSURE: 0.1,
  PRESSURE_ITERATIONS: 20,
  CURL: 3 /*  How many curls will exists at the outer edge of a movement, default: 10 */,
  SPLAT_RADIUS: 0.2 /*  Radius of each movement, defualt:0.4 */,
  SPLAT_FORCE: 3000 /* How fast each movement is jetted out, default: 6000   */,
  SHADING: true,
  COLORFUL: true,
  ...
  SUNRAYS_WEIGHT: 0.5 /* How bright the colors are, default: 1.5 */,
};
